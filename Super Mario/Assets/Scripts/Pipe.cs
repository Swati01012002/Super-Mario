...
{
    public Transform connection; //where the pipe leads to
    ...
    private IEnumerator Enter(Transform player)
    {
        ...
        bool underground = connection.position.y < 0f; //for camera to be set in underground
        Camera.main.GetComponent<Scrolling>().SetUnderground(underground);
